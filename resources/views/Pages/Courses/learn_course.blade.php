            ...
            <div class="row" id="lesson-container">
               <div class="col-lg-8 order-md-1 course_col" id="video_player_area">
                  ...
                  <div class="" style="text-align: center">
                     ...
                     <div
                        class="plyr plyr--full-ui plyr--video plyr--youtube plyr--fullscreen-enabled plyr--paused plyr--stopped plyr__poster-enabled"
                        id="player">
                     ...
                     <div class="col-12">
                        ...
                        <div class="tab-content" id="lessonTabContent">
                           ...
                           <div class="tab-pane fade" id="certificate" role="tabpanel" aria-labelledby="certificate-tab"
                              ...
                              <div class="circular-progressdiv" id="course_progress_area" data-percent="100">
                                 <svg class="circular-progress" viewport="0 0 100 100" version="1.1"
                                    ...
                                    <circle class="bar" r="80" cx="89" cy="89" fill="transparent" stroke-dasharray="502.4"
                                       stroke-dashoffset="0" style="stroke-dashoffset: 502.4"></circle>
                                 </svg>
                              </div>
                              <div class="alert alert-info" id="certificate-alert-warning" role="alert"
                                 ...
                                 <hr />
                                 <p>
                                    You have completed <span id="progression">100</span>% Of
                                    the course
                                 </p>
                                 <p>
                                    You can download the course completion certificate after
                              ...
                              <div class="alert alert-success" id="certificate-alert-success" role="alert">
                                 ...
                                 <p>Congratulations!!!</p>
                                 <p>
                                    You are now eligible to download the course completion
                                    certificate.
                                 </p>
                              </div>
                     ...
                     <div class="col-lg-4 col-md-3">
                        <div class="footer-widget">
                           ...
                           <div class="footer-add">
                              ...
                              <p>
                                 <i class="fa fa-phone" aria-hidden="true"></i> +84 961 340
                                 573
                              </p>
                              <p>
               ...
               <div class="container">
                  <div class="row align-items-center">
                     <div class="col-lg-6 col-md-6">
                        <p class="mb-0">
                           © 2020 LearnUp. Designd By <a href="#">Nguyen Minh Long</a>.
                        </p>
                     </div>
